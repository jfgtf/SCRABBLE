...
# class Board_Label(QtWidgets.QLabel):
#         def __init__(self):
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.board_label_13_4.setStyleSheet("background-color:\"blue\"\n""")
        ...
        self.board_label_13_5.setStyleSheet("background-color:\"green\"\n""")
        ...
        self.board_label_13_8.setStyleSheet("background-color:\"blue\"\n""")
        ...
        self.board_label_13_9.setStyleSheet("background-color:\"green\"\n""")
        ...
        self.board_label_13_13.setStyleSheet("background-color:\"green\"\n""")
        ...
        self.widget_18.setGeometry(QtCore.QRect(660, 0, 211, 901))
        self.widget_18.setObjectName("widget_18")
        self.ilosc_punktow = QtWidgets.QLabel(self.widget_18)
        self.ilosc_punktow.setGeometry(QtCore.QRect(70, 60, 100, 23))
        self.ilosc_punktow.setObjectName("ilosc_punktow")
        self.player_name = QtWidgets.QLabel(self.widget_18)
        self.player_name.setGeometry(QtCore.QRect(70, 20, 100, 23))
        self.player_name.setObjectName("player_name")
        self.ilosc_liter_TXT = QtWidgets.QLabel(self.widget_18)
        self.ilosc_liter_TXT.setGeometry(QtCore.QRect(70, 200, 70, 23))
        self.ilosc_liter_TXT.setObjectName("ilosc_liter_TXT")
        self.ilosc_liter_TXT.setText("Ilosc liter:")
        self.ilosc_liter = QtWidgets.QLabel(self.widget_18)
        self.ilosc_liter.setGeometry(QtCore.QRect(160, 200, 30, 23))
        self.ilosc_liter.setObjectName("ilosc_liter")
        self.clear = QtWidgets.QPushButton(self.widget_18)
        self.clear.setGeometry(QtCore.QRect(70, 640, 100, 23))
        self.clear.setObjectName("clear")
        self.clear.clicked.connect(self.clicked_clear)
        self.confirm = QtWidgets.QPushButton(self.widget_18)
        self.confirm.setGeometry(QtCore.QRect(70, 500, 100, 23))
        ...
        self.change_letters = QtWidgets.QPushButton(self.widget_18)
        self.change_letters.setGeometry(QtCore.QRect(70, 300, 100, 23))
        ...
        self.change_letters_cancel = QtWidgets.QPushButton(self.widget_18)
        self.change_letters_cancel.setGeometry(QtCore.QRect(70, 400, 100, 23))
        ...
        self.change_letters_confirm = QtWidgets.QPushButton(self.widget_18)
        self.change_letters_confirm.setGeometry(QtCore.QRect(70, 350, 100, 23))
        ...
        self.change_letters_confirm.clicked.connect(self.safe_words)
        self.change_letters_confirm.clicked.connect(self.change_player)
        ...
        self.pushButton1.setGeometry(QtCore.QRect(20, 10, 75, 81))
        ...
        self.pushButton2.setGeometry(QtCore.QRect(110, 10, 75, 81))
        ...
        self.pushButton3.setGeometry(QtCore.QRect(200, 10, 75, 81))
        ...
        self.pushButton4.setGeometry(QtCore.QRect(290, 10, 75, 81))
        ...
        self.pushButton5.setGeometry(QtCore.QRect(380, 10, 75, 81))
        ...
        self.pushButton6.setGeometry(QtCore.QRect(470, 10, 75, 81))
        ...
        self.pushButton7.setGeometry(QtCore.QRect(560, 10, 75, 81))
        ...
        self.players_names = ["XD", "yo", "dupa", "segz"]
        ...
        self.ilosc_punktow.setText(str(self.dict_players[0][8]))
        ...
        self.ilosc_liter.setText(str(len(self.letter_list)))
    ...
    def clicked_confirm(self):
        self.which_move += 1
        self.new_player_move_board = self.actual_board
    ...
    def clicked_change_letters_confirm(self):
        if self.change_letters_check == 1:
            ...
            if self.number_buttons_to_change <= len(self.letter_list):
    ...
    def change_player(self):
        ...
        self.ilosc_punktow.setText(str(self.dict_players[self.current_player][8]))
    ...
    def retranslateUi(self, Form):
        ...
        self.board_label_13_4.setText(_translate("Form", "TL"))
        self.board_label_13_8.setText(_translate("Form", "TL"))
        self.board_label_13_12.setText(_translate("Form", "DW"))
